...
export default function CohortAiLanding() {
  ...
  const [toast, setToast] = useState<ToastState>({ open: false, type: "info", title: "", desc: "" });
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 grid md:grid-cols-3 gap-8 text-sm">
          ...
          <div>
            ...
            <ul className="space-y-2 text-slate-700">
              ...
              <li>
                <a href="/terms" className="hover:bg-gradient-to-r hover:from-sky-500 hover:to-[#25c19b] hover:bg-clip-text hover:text-transparent">Terms</a>
              </li>
