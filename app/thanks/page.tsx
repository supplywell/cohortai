...
export const metadata = {
  ...
  description: "You're nearly there — check your inbox and confirm your email to join The Plan.",
};
    ...
    <main className="min-h-[70vh] bg-gradient-to-br from-sky-50 via-white to-[#25c19b]/10">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
        <Image
          ...
          className="mx-auto h-10 w-auto object-contain mb-6"
        />
        ...
        <p className="mt-3 text-slate-700">
          We’ve sent a confirmation link to your inbox. Click it to complete your subscription to <span className="font-semibold">The Plan</span>.
        </p>
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="text-sm text-slate-700">
              ...
              <ul className="list-disc list-inside mt-2 space-y-1">
                ...
                <li>Add <span className="font-mono">no-reply@mailchimp.com</span> to your safe senders.</li>
